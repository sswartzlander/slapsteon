...
namespace Insteon
{
    public class SolarTime
    {
        ...
        private double CalculateGeometricMeanLongitudeOfSun(double t)
        {
        ...
        {
            double m = CalculateGeometricMeanLongitudeOfSun(t);
        ...
        {
            double l0 = CalculateGeometricMeanLongitudeOfSun(t);
        ...
        private double CalculateEquationOfTime(double t)
        {
            ...
            var l0 = CalculateGeometricMeanLongitudeOfSun(t);
